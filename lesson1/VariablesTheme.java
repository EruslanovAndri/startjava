...
public class VariablesTheme {
	public static void main(String[] args) {
		...
		System.out.printf("%n %d %n %d %n %d %n %d %n %d %n %d %n"
			,codeAsciiOne,codeAsciiTwo,codeAsciiThree,codeAsciiFour,codeAsciiFive,codeAsciiSix);
		...
		System.out.printf("%n %d %5c %n %d %5c %n %d %5c %n %d %5c %n %d %5c %n %d %5c"
			,codeAsciiOne,ch1,codeAsciiTwo,ch2,codeAsciiThree,ch3,codeAsciiFour,ch4,codeAsciiFive,ch5,codeAsciiSix,ch6);
		...
		"Параметры JVM:",
				...
				"Выделенная память - ",(float) maxMemory / (1024 * 1024),"Мб",
				"Свободная память - ",(float) freeMemory / (1024 * 1024),"Мб",
				"Используемая память - ", (float) (maxMemory - freeMemory) / 1_048_576,"Мб",
				"Максимально доступная для выделения память - ",(float) (maxMemory + freeMemory) / 1_048_576, "Мб");
