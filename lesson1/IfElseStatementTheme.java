    ...
    public static void main(String[] args) {
        ...
        if (numChar >= 0 && numChar <= 64 || numChar >= 91 && 
            ...
            System.out.printf("%s %s %n %s %s", "Имя: ", name,
                    "начинается с символа -", firstChar);
        } else if (numChar >= 48 && numChar <= 57) {
            System.out.printf("%s %s %n %s %s", "Имя: ", name,
                    "начинается с цифры -", firstChar);
        } else if (numChar >= 65 && numChar <= 90) {
            System.out.printf("%s %s %n %s %s", "Имя: ", name,
                    "начинается с большой буквы -", firstChar);
        ...
        if (serialNumberLength == itemNumberLength && serialNumber == itemNumber) {
            ...
            System.out.printf("%s %d %s", "[№", itemNumber,
                    "]: оборудование не найдено.");
        } else if (serialNumberLength > itemNumberLength && 
